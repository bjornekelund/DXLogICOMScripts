...
namespace DXLog.net
{
    public class IcomRitPlus : ScriptClass
    {
        ...
        public void Main(FrmMain main, ContestData cdata, COMMain comMain)
        {
            ...
            if (radio1 == null)  
            {
                main.SetMainStatusText("IcomRitPlus: Radio 1 is not available.");
                return;
            }
            ...
            { 
                ...
                { /// If radio 2 is focursed and SO2R and RUN, do RIT on radio 2 
                    ...
                    if (Debug) main.SetMainStatusText(String.Format("IcomRitPlus: Radio2: RIT offset = {0}", radio2.RitOffSet));
                }
                ...
                { // if radio 2 is focused and S&P
                    ...
                    { // if radio 2 is focused and S&P and technique is SO2R, adjust VFO A on radio 2
                        ...
                        if (Debug) main.SetMainStatusText(String.Format("IcomRitPlus: Radio 2: VFO A: {0:F2}", cdata.Radio2_FreqA));
                    }
                    else
                    { // if radio 2 is focused and S&P and technique is SO1R or SO2V, adjust VFO B on radio 1
                        ...
                        if (Debug) main.SetMainStatusText(String.Format("IcomRitPlus: Radio 1: VFO B: {0:F2}", cdata.Radio1_FreqB));
                    }
                }
            }
        }
